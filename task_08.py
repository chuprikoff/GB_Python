...
# Файл "contacts.txt" будет проверяться и создаваться в директории, где находится исполняемый код программы.
# Когда программа выполняется, она будет искать файл "contacts.txt" в текущей рабочей директории.
# Если файл "contacts.txt" не существует в текущей директории, программа создаст его при первом сохранении контакта.

# Если мы хотим изменить директорию, в которой будет создан файл "contacts.txt", мы можем указать полный путь к файлу при его открытии и сохранении:

# filename = '/полный/путь/к/файлу/contacts.txt'

# Мы можем заменить "/полный/путь/к/файлу" на фактический путь к директории, где мы хотим создать файл "contacts.txt".
# Таким образом, мы можем контролировать, где будет создан файл "contacts.txt" и где программа будет искать его для чтения и записи данных контактов.
